        ...
        <div className="container mx-auto px-4 py-8">
            <div className="flex justify-between items-center mb-6">
                ...
                <Link
                    ...
                    className="bg-primary text-gray-600 py-2 px-4 rounded hover:bg-primary-dark transition flex items-center gap-2"
                >
                    ...
                    {products.length > 0 ? (
                        ...
                        <div className="text-center py-12">
                            ...
                            <div className="mt-6">
                                <Link
                                    to="/admin/products/new"
                                    className="bg-primary text-gray-600 py-2 px-4 rounded hover:bg-primary-dark transition inline-flex items-center"
                                >
